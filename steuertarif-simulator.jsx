...
@media(max-width:800px){.gm{grid-template-columns:1fr!important}}`}</style>
      <div style={{ maxWidth: 960, margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", borderBottom: `2px solid ${C.text}`, paddingBottom: 10, marginBottom: ss ? 10 : 20, flexWrap: "wrap", gap: 8 }}>
          <div>
            <h1 style={{ fontSize: 20, fontWeight: 700, color: C.text, letterSpacing: "-.02em" }}>Steuertarif-Simulator <span style={{ fontWeight: 400, color: C.light, fontSize: 13 }}>§32a EStG · VZ 2026</span></h1>
        ...
        {/* CREATOR */}
        <div style={{ background: C.card, border: `1px solid ${C.border}`, borderRadius: 8, padding: "18px 20px", marginBottom: 18, display: "flex", gap: 16, alignItems: "center", flexWrap: "wrap" }}>
          <img src="https://pbs.twimg.com/profile_images/2030219620234207232/VxzgJ6EF_400x400.jpg" alt="Leon J. Bergmann" style={{ width: 68, height: 68, borderRadius: "50%", flexShrink: 0, border: `3px solid ${C.border}`, objectFit: "cover" }} onError={e => { e.target.src = "profile.jpg"; e.target.onerror = () => { e.target.outerHTML = '<div style="width:68px;height:68px;border-radius:50%;background:#f0ece6;display:flex;align-items:center;justify-content:center;font-size:24px;font-weight:700;color:#6b6560;border:3px solid #e8e5df;flex-shrink:0">LB</div>'; }; }} />
